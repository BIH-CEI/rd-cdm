...
class DATA_ELEMENTS_VERSIONS_V2_0_0:
    ...
    data_elements = [
        DataElement(
            ...
            elementCode=Coding(system=SNOMED_CT, code="422549004"),
            elementCodeSystem=SNOMED_CT,
            dataType="Identifier",
        ...
        DataElement(
            ...
            elementCode=Coding(system=SNOMED_CT, code="399423000"),
            elementCodeSystem=SNOMED_CT,
            dataType="Date",
        ...
        DataElement(
            ...
            elementCode=Coding(system=SNOMED_CT, code="184099003"),
            elementCodeSystem=SNOMED_CT,
            dataType="Date",
        ...
        DataElement(
            ...
            elementCode=Coding(system=SNOMED_CT, code="281053000"),
            elementCodeSystem=SNOMED_CT,
            dataType="Code",
