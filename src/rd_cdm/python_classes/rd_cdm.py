...
# Generation date: 2025-08-07T11:34:15
...
from linkml_runtime.linkml_model.types import Curie, String, Uri
from linkml_runtime.utils.metamodelcore import Curie, URI
...
RDCDM = CurieNamespace('rdcdm', 'https://github.com/BIH-CEI/rd-cdm/linkml/')
...
class RDCDM(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = RDCDM["rd_cdm.schema.yaml/RDCDM"]
    class_class_curie: ClassVar[str] = "rdcdm:rd_cdm.schema.yaml/RDCDM"
    ...
    code_systems: Optional[Union[Union[dict, "CodeSystem"], list[Union[dict, "CodeSystem"]]]] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        self._normalize_inlined_as_dict(slot_name="code_systems", slot_type=CodeSystem, key_name="id", keyed=False)

        self._normalize_inlined_as_dict(slot_name="data_elements", slot_type=DataElement, key_name="ordinal", keyed=False)

        self._normalize_inlined_as_dict(slot_name="value_sets", slot_type=ValueSet, key_name="id", keyed=False)
...
class CodeSystem(YAMLRoot):
    """
    Metadata for an ontology/code system
    """
    _inherited_slots: ClassVar[list[str]] = []

    class_class_uri: ClassVar[URIRef] = RDCDM["rd_cdm.schema.yaml/CodeSystem"]
    class_class_curie: ClassVar[str] = "rdcdm:rd_cdm.schema.yaml/CodeSystem"
...
class Coding(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = RDCDM["rd_cdm.schema.yaml/Coding"]
    class_class_curie: ClassVar[str] = "rdcdm:rd_cdm.schema.yaml/Coding"
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.system, Curie):
            self.system = Curie(self.system)
...
class ValueSet(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = RDCDM["rd_cdm.schema.yaml/ValueSet"]
    class_class_curie: ClassVar[str] = "rdcdm:rd_cdm.schema.yaml/ValueSet"
...
class DataElement(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = RDCDM["rd_cdm.schema.yaml/DataElement"]
    class_class_curie: ClassVar[str] = "rdcdm:rd_cdm.schema.yaml/DataElement"
    ...
    elementCodeSystem: Union[str, Curie] = None
    section: Optional[str] = None
    dataType: Optional[str] = None
    dataSpecification: Optional[Union[str, list[str]]] = empty_list()
    valueSet: Optional[Union[str, Curie]] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.elementCodeSystem, Curie):
            self.elementCodeSystem = Curie(self.elementCodeSystem)
        ...
        if self.valueSet is not None and not isinstance(self.valueSet, Curie):
            self.valueSet = Curie(self.valueSet)
...
slots.rDCDM__code_systems = Slot(uri=DEFAULT_.code_systems, name="rDCDM__code_systems", curie=DEFAULT_.curie('code_systems'),
                   model_uri=DEFAULT_.rDCDM__code_systems, domain=None, range=Optional[Union[Union[dict, CodeSystem], list[Union[dict, CodeSystem]]]])
...
slots.codeSystem__id = Slot(uri=DEFAULT_.id, name="codeSystem__id", curie=DEFAULT_.curie('id'),
                   model_uri=DEFAULT_.codeSystem__id, domain=None, range=Union[str, Curie])

slots.codeSystem__name = Slot(uri=DEFAULT_.name, name="codeSystem__name", curie=DEFAULT_.curie('name'),
                   model_uri=DEFAULT_.codeSystem__name, domain=None, range=str)

slots.codeSystem__url = Slot(uri=DEFAULT_.url, name="codeSystem__url", curie=DEFAULT_.curie('url'),
                   model_uri=DEFAULT_.codeSystem__url, domain=None, range=Union[str, URI])
...
slots.coding__system = Slot(uri=DEFAULT_.system, name="coding__system", curie=DEFAULT_.curie('system'),
                   model_uri=DEFAULT_.coding__system, domain=None, range=Union[str, Curie])
...
slots.dataElement__elementCodeSystem = Slot(uri=DEFAULT_.elementCodeSystem, name="dataElement__elementCodeSystem", curie=DEFAULT_.curie('elementCodeSystem'),
                   model_uri=DEFAULT_.dataElement__elementCodeSystem, domain=None, range=Union[str, Curie])
...
slots.dataElement__valueSet = Slot(uri=DEFAULT_.valueSet, name="dataElement__valueSet", curie=DEFAULT_.curie('valueSet'),
                   model_uri=DEFAULT_.dataElement__valueSet, domain=None, range=Optional[Union[str, Curie]])
