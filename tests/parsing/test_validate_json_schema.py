...
JSON_FILES_AND_SCHEMAS = [
    ("res/v2_0_0_dev0/rd_cdm_codesystems_v2_0_0.json", CODE_SYSTEMS_SCHEMA),
    ("res/v2_0_0_dev0/rd_cdm_data_elements_v2_0_0.json", DATA_ELEMENTS_SCHEMA),
    ("res/v2_0_0_dev0/rd_cdm_value_sets_v2_0_0.json", VALUE_SETS_SCHEMA),
    ("res/v2_0_0_dev0/rd_cdm_v2_0_0.json", FULL_MODEL_SCHEMA),
]
